				...
				<div class="wfg-criteria">
					...
					?>
						<div class="wfg-criteria-item shadow" data-id='1'>
							<input type="text" name="_wfg_criteria[criteria-1][name]" placeholder="<?php echo WFG_Common_Helper::translate( 'Name this criteria' )  ?>" 
								...
								<div class="wfg-criteria-options-wrap" data-id='1'>
									...
									<input type="text" name="_wfg_criteria[criteria-1][condition][]" value="<?php echo isset($condition[2]) ? $condition[2] : '' ?>" 
